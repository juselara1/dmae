...
# Modified by: Juan Lara <julara@unal.edu.co>
...
class KMedoids(BaseEstimator, ClusterMixin, TransformerMixin):
    ...
    samples : int, optional, default: 20000
        Specify the number of samples that are used to build the similarity matrix.
    Attributes
    ----------
    ...
    def __init__(self, n_clusters=8, metric="euclidean", init="k-medoids++", max_iter=300, random_state=None,
                 samples=20000):
